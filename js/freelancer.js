...
$('.navbar-collapse ul li a').click(function() {
    $('.navbar-toggle:visible').click();
        ...
        var skillsAdded = 0;
          ...
          for (let pair of competencies) {
            ...
            if (pair[1] == true) {
              ...
              var toPass = 9*(answerSkill[1]/answerSkill[0]);
              var score = Math.log(toPass+1);
      ...
      tagRequest.open("GET", "https://api.stackexchange.com/2.2/users/3375847/top-answer-tags?site=stackoverflow", true);
      tagRequest.send();
